...
urlpatterns = [
    ...
    path('guestbook/', guestbook_views.guestbook),
    ...
    path('board/write', board_views.writeform),
    path('board/modify', board_views.modifyform),
    path('board/view', board_views.viewform),
